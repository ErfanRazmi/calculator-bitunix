              ...
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-gray-900 p-2 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-[0_4px_15px_rgb(0,0,0,0.06)] flex justify-center w-full max-w-sm mx-auto mb-6">
                  <button 
                    ...
                    className={`flex-1 py-2 px-4 rounded-xl font-bold text-sm transition-all duration-200 ${pnlType === 'raw' ? 'bg-gray-900 dark:bg-black text-white shadow-md' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'}`}
                  >
                    Raw PnL
                  </button>
                  <button 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div className="bg-gray-900 dark:bg-black p-8 rounded-3xl shadow-xl relative overflow-hidden group border border-gray-800">
